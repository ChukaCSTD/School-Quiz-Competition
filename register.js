...
const registrationDeadline = new Date('October 2, 2024');
...
if (currentDate > registrationDeadline) {
    deadlineMessage.innerText = `<span class="text-xs">Registration is closed. A fine of N5,000 is required to be eligible. Find remit details below.</span>`;
